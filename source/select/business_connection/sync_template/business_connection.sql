SELECT  bill.fid                                                                                                 AS "id"
       ...
       ,case bill.fbillstatus WHEN 'A' THEN '暂存' WHEN 'B' THEN '已提交' WHEN 'C' THEN '已审核' WHEN 'D' THEN '已完成' end AS "单据状态"
...
LEFT JOIN crrc_sys.t_sec_user check_user
ON bill.fk_crrc_issuer = check_user.FID

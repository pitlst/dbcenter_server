...
WHERE
  ...
  AND v.planned_start_time >= to_date(to_char(sysdate,'yyyy-mm-dd')||'00:00:01', 'YYYY-MM-DD HH24:MI:SS')
  AND v.planned_start_time <= to_date(to_char(sysdate,'yyyy-mm-dd')||'23:59:59', 'YYYY-MM-DD HH24:MI:SS')
GROUP BY
  v.project,
  v.car_code,
  v.singer_car_code,

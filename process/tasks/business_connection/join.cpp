...
void task_bc_join::logic_class_group()
{
    try
    {
...
void task_bc_join::logic_technological_process()
{
    try
    { 
        auto client = MONGO.init_client();
...
void task_bc_join::logic_business_connection()
{
    try
    {
        auto client = MONGO.init_client();
...
void task_bc_join::logic_design_change()
{
    try
    {
        auto client = MONGO.init_client();
...
void task_bc_join::logic_shop_execution()
{
    try
    {
        auto client = MONGO.init_client();
...
void task_bc_join::logic_design_change_execution()
{
    try
    {
        auto client = MONGO.init_client();
...
void task_bc_join::main_logic()
{
    this->tg.run(std::bind(&task_bc_join::logic_class_group, this));
    this->tg.run(std::bind(&task_bc_join::logic_technological_process, this));
    this->tg.run(std::bind(&task_bc_join::logic_business_connection, this));
    this->tg.run(std::bind(&task_bc_join::logic_design_change, this));
    this->tg.run(std::bind(&task_bc_join::logic_shop_execution, this));
    this->tg.run(std::bind(&task_bc_join::logic_design_change_execution, this));
    this->tg.wait();
}
